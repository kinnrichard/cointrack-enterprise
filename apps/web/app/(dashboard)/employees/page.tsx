...
import {
  Users, Pencil, Trash2, UserCheck, UserMinus, UserX, Loader2, Filter, X, Upload, Camera, Eye, Mail, Phone, MapPin, Building2 as BuildingIcon, Briefcase, Calendar as CalendarIcon2, CreditCard, Shield,
} from 'lucide-react';
...
function DetailCard({ title, items }: { title: string; items: { label: string; value: string | null | undefined }[] }) {
