...
import { z } from 'zod';
import { DollarSign, Pencil, Trash2, Users, Loader2 } from 'lucide-react';
...
export default function RatesPage() {
  ...
  const filtered = statusFilter === 'all' ? rates : statusFilter === 'active' ? rates.filter((r) => r.isActive) : rates.filter((r) => !r.isActive);
